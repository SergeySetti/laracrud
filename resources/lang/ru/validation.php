    ...
    */
    ...
    'custom'               => [
        ...
        'good_name' => [
            ...
            'min' => 'Название товара должно содержать не менее :min символов',
            'max' => 'Название товара должно содержать не более :max символов',
        ],
        'good_price' => [
            'required' => 'Цену нужно указать',
            'min' => 'Цена не должна быть нулевой',
            'numeric' => 'Цена должна быть числовым значением',
        ],
    ],
